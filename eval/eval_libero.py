...
def main():
    ...
    #     # required=False,
    #     # required=True,  # for now, to avoid mistakes, we require task_name to be provided. If task_suite_name is provided, we will evaluate on all the tasks in the task suite, otherwise we will evaluate on the specified task.
    # )
    parser.add_argument(
        "--task_suite_name",
        type=str,
    ...
    parser.add_argument(
        "--log_dir",
        type=str,
        help="Name of the directory to store the results in.",
    )
    parser.add_argument(
